-- db_futcodeTest.sql - Refactorizado para HSQLDB y tests

-- SECCIÓN DE LIMPIEZA COMPLETA (Orden Inverso de Dependencias de Claves Foráneas)
-- Usar DELETE simple sin IF EXISTS para HSQLDB
...
-- INSERTS DE ENTIDADES BÁSICAS / SIN DEPENDENCIAS
...
-- INSERTS DE ENTIDADES CON DEPENDENCIAS BASICAS
-- Equipos para tests de Torneo (IDs 201-205)
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (201, 'Los Invencibles', 1, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (202, 'Fuerza Unida', 2, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (203, 'Rayos X', 1, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (204, 'Deportivo Test', 2, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (205, 'Estrellas FC', 1, 1000);

-- Equipos de Prueba para FormacionEquipoRepository (IDs 100-104)
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (100, 'Equipo Formacion Test', 1, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (101, 'Equipo Sin Formacion Test', 2, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (102, 'Equipo Para Eliminar Formacion', 1, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (103, 'Equipo Para Guardar Formacion', 1, 1000);
INSERT INTO equipo (id, nombre, esquema_id, usuario_id) VALUES (104, 'Equipo Extra Sin Jugadores', 1, 1000);

-- INSERTS DE TORNEO Y EQUIPOTORNEO
...
-- INSERTS DE JUGADOR Y FORMACION_EQUIPO
...
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5000, 'Sortear', 'ArqueroRaro1', NULL, 28, 1, 80.0, 0, 90.00, 1, 'RARO', 'ARQUERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5001, 'Sortear', 'ArqueroRaro2', NULL, 29, 12, 81.0, 0, 91.00, 2, 'RARO', 'ARQUERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5002, 'Sortear', 'ArqueroRaro3', NULL, 27, 25, 79.0, 0, 89.00, 3, 'RARO', 'ARQUERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5003, 'Sortear', 'DelanteroEpico1', NULL, 25, 9, 88.0, 0, 95.00, 1, 'EPICO', 'DELANTERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5004, 'Sortear', 'DelanteroEpico2', NULL, 26, 11, 89.0, 0, 96.00, 3, 'EPICO', 'DELANTERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5005, 'Sortear', 'DelanteroEpico3', NULL, 24, 10, 87.0, 0, 94.00, 2, 'EPICO', 'DELANTERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5006, 'Sortear', 'MedioLeyenda1', NULL, 30, 8, 92.0, 0, 98.00, 1, 'LEYENDA', 'MEDIOCAMPISTA', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5007, 'Sortear', 'MedioLeyenda2', NULL, 31, 6, 93.0, 0, 99.00, 2, 'LEYENDA', 'MEDIOCAMPISTA', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5008, 'EquipoA', 'Jugador1', NULL, 25, 7, 85.0, 0, 90.00, 1, 'NORMAL', 'DELANTERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5009, 'EquipoA', 'Jugador2', NULL, 26, 8, 86.0, 0, 91.00, 1, 'NORMAL', 'MEDIOCAMPISTA', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5010, 'EquipoB', 'Jugador1', NULL, 27, 9, 84.0, 0, 89.00, 2, 'NORMAL', 'DEFENSOR', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5011, 'EquipoB', 'Jugador2', NULL, 28, 10, 85.0, 0, 90.00, 2, 'NORMAL', 'ARQUERO', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5012, 'Jugador', 'Individual', NULL, 22, 15, 75.0, 0, 85.00, 1, 'NORMAL', 'DEFENSOR', NULL);
INSERT INTO jugador (id, nombre, apellido, imagen, edad, numero_camiseta, rating, lesionado, estado_fisico, pais_id, rareza_jugador, posicion, sobre_id) VALUES (5013, 'Jugador', 'A Actualizar', NULL, 23, 16, 78.0, 0, 88.00, 1, 'NORMAL', 'DELANTERO', NULL);
